...
| [rast-perspective.txt](files/rast-perspective.txt) | [<img class="demo big" src="files/rast-perspective.png"/>](files/rast-perspective.png) | The left wall is split in the middle; the right wall is not; they should have the same overall color, and match the color of the horizontal bar where it crosses them. |
